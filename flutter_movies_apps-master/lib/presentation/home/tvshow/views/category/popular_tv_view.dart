...
class PopularTvView extends GetView<TvShowController> {
  ...
  Widget build(BuildContext context) {
    return Obx(() => !controller.isPopularLoading.value
      ...
      child: ListView.builder(
        ...
        itemCount: controller.popularTv.value.results!.length,
      ),
    )
        : verticalItemShimmer());
  }
  ...
  Widget _items(index) {
    final item = controller.popularTv.value.results![index];
